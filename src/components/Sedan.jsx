        ...
        <Form className="border border-seconday rounded p-3">
              <Row>
                ...
                <Row className='mt-3'>
                  ...
                  <Col>
                    <Form.Control type='text' placeholder="Enter Vehicle Number (KL08AZ1234)" pattern="[A-Za-z0-9]*" title="Vehicle number should contain only alphabets and digits (0-9)." value={bookingDetails.vehiclenumber} onChange={(e) => setBookingDetails({ ...bookingDetails, vehiclenumber: e.target.value })} isInvalid={bookingDetails.vehiclenumber && !/^[A-Z]{2}[ -]?[0-9]{2}[ -]?[A-Z]{1,2}[ -]?[0-9]{4}$/.test(bookingDetails.vehiclenumber)} />
